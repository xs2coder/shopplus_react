                          ...
                          <div className="width-100">
                            <ul className="list-inline customNewCheck padding-y-4 margin-none">
                              <li className="list-inline-item display-inline-block">
                                ...
                                <label className="font-size-14 text-grey margin-bottom-8 display-inline-block" htmlFor="OffersCheck">Offers</label>
                              </li>
                              <li className="list-inline-item display-inline-block">
                                <input type="checkbox" id="BrandsCheck" />
                                <label className="font-size-14 text-grey margin-bottom-8 display-inline-block" htmlFor="BrandsCheck">Brands</label>
                              </li>
                              <li className="list-inline-item display-inline-block">
                                <input type="checkbox" id="allCheck" />
                                <label className="font-size-14 text-grey margin-bottom-8 display-inline-block" htmlFor="allCheck">All</label>
                              </li>
                            </ul>
                          </div>
